...
public class CartView extends CartEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		//级联表 yonghu
			...
			* 班级
			*/
			private Integer yonghuErjiTypes;
				/**
				* 班级的值
				*/
				private String yonghuErjiValue;
			/**
			* 电子邮箱
			*/
		...
		try {
			...
			e.printStackTrace();
				...
				//级联表的get和set yonghu
					...
					* 获取： 班级
					*/
					public Integer getYonghuErjiTypes() {
						return yonghuErjiTypes;
					}
					/**
					* 设置： 班级
					*/
					public void setYonghuErjiTypes(Integer yonghuErjiTypes) {
						this.yonghuErjiTypes = yonghuErjiTypes;
					}
						...
						* 获取： 班级的值
						*/
						public String getYonghuErjiValue() {
							return yonghuErjiValue;
						}
						/**
						* 设置： 班级的值
						*/
						public void setYonghuErjiValue(String yonghuErjiValue) {
							this.yonghuErjiValue = yonghuErjiValue;
						}
					/**
					* 获取： 电子邮箱
					*/
