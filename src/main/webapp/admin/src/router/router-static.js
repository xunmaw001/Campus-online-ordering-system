...
import center from '@/views/center'
    ...
    import dictionaryYonghuErji from '@/views/modules/dictionaryYonghuErji/list'
        import dictionaryYonghuErjiAddOrUpdate from '@/views/modules/dictionaryYonghuErji/add-or-update'//二级
...
const routes = [{
    ...
    ,{
        path: '/dictionaryYonghuErji',
        name: '班级',
        component: dictionaryYonghuErji
    }
    ,{
        path: '/dictionaryYonghuErjiAddOrUpdate',
        name: '班级的新增修改页面',
        component: dictionaryYonghuErjiAddOrUpdate
    }
    ,{
        path: '/config',
        name: '轮播图',
