    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='caipin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="一级分类" prop="caipinValue">
                        <el-input v-model="caipinForm.caipinValue"
                                  placeholder="一级分类" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="一级分类" prop="caipinValue">
                ...
                <el-col :span="12"  v-if="sessionTable !='caipin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="二级分类" prop="caipinErjiValue">
                        <el-input v-model="caipinForm.caipinErjiValue"
                                  placeholder="二级分类" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="二级分类" prop="caipinErjiValue">
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="学院" prop="yonghuValue">
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="班级" prop="yonghuErjiValue">
                        <el-input v-model="yonghuForm.yonghuErjiValue"
