        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="学院" prop="yonghuTypes">
                        <el-select v-model="ruleForm.yonghuTypes" :disabled="ro.yonghuTypes" placeholder="请选择学院" @change="yonghuTypesChange">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="学院" prop="yonghuValue">
                        <el-input v-model="ruleForm.yonghuValue"
                            placeholder="学院" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12" v-if="ruleForm.yonghuTypes != null && ruleForm.yonghuTypes != ''">
                    <el-form-item class="select" v-if="type!='info'"  label="班级" prop="yonghuErjiTypes">
                        <el-select v-model="ruleForm.yonghuErjiTypes" :disabled="ro.yonghuErjiTypes" placeholder="请选择班级">
                            <el-option
                                v-for="(item,index) in yonghuErjiTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="班级" prop="yonghuErjiValue">
                        <el-input v-model="ruleForm.yonghuErjiValue"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //动态查询班级
            yonghuTypesChange(id){
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yonghu_erji_types&superId=${id}`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.ruleForm.yonghuErjiTypes = null;
                        this.yonghuErjiTypesOptions = data.data.list;
                    }
                });
            },
            //动态查询班级
            yonghuErjiTypesChange(id){
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yonghu_erji_types&superId=${id}`,
                    method: "get"
                }).then(({ data }) => {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.yonghuErjiTypesChange(data.data.yonghuTypes);
                    } else {
