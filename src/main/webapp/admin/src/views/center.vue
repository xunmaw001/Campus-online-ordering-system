  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='学院' prop="yonghuTypes">
                 <el-select v-model="ruleForm.yonghuTypes"  placeholder='请选择学院' @change="yonghuTypesChange">
                     <el-option
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='班级' prop="yonghuErjiTypes">
                 <el-select v-model="ruleForm.yonghuErjiTypes"  placeholder='请选择班级'>
                     <el-option
...
export default {
  ...
  mounted() {
    ...
    this.$http({
      ...
      _this.$http({
       ...
       if (data && data.code === 0) {
           _this.yonghuTypesOptions = data.data.list;
           _this.$http({
               url: `dictionary/page?page=1&limit=100&sort=&order=&dicCode=yonghu_erji_types&superId=`+this.ruleForm.yonghuTypes,
               method: "get"
           }).then(({ data }) => {
               if (data && data.code === 0) {
                   _this.yonghuErjiTypesOptions = data.data.list;
               } else {
      ...
      _this.$http({
       ...
       if (data && data.code === 0) {
           _this.huiyuandengjiTypesOptions = data.data.list;
      } else {
           _this.$message.error(data.msg);
      }
    });
  ...
  methods: {
    yonghuTypesChange() {
        let _this = this;
        _this.ruleForm.yonghuErjiTypes = null;
        _this.$http({
            url: `dictionary/page?page=1&limit=100&sort=&order=&dicCode=yonghu_erji_types&superId=`+this.ruleForm.yonghuTypes,
            method: "get"
        }).then(({ data }) => {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.yonghuErjiTypes)&& 'yonghu'==this.flag){
